...
globalDbName = 'Api-Test' # request.cr.dbname
base_url = 'http://localhost:8010' #request.httprequest.base_url
globalUserId = 1
...
class RestApi(http.Controller):
    ...
    def valid_authentication(self, kwargs):
        ...
        if kwargs.get('oauth_signature'):
            ...
            redirect_url = add_params_to_uri(base_url, kwargs)
    ...
    def perform_model_request(self, object, method, **kwargs):
        ...
        if not user or invalid:
            return self.get_response(401, '401', {'code': 401, 'message': 'Authentication required'})
        return self.perform_request(object, id=None, method=method, kwargs=kwargs, user=1)
    ...
    def perform_multi_request(self, object, id=None, method=None, **kwargs):
        ...
        return self.perform_request(object, id=id, method=method, kwargs=kwargs, user=1)
    ...
    def perform_request(self, object, method=None, id=None, kwargs={}, user=None):
        ...
        try:
            ...
            data = model.execute_kw(globalDbName, globalUserId, object, method, arguments, kw=k_arguments)
            ...
            if method=='search_read' and data_description in ['res.users', 'res.partner'] :
                i=0 
                for key in data:
                    data_temp = {}
